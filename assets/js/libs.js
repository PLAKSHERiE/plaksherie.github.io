...
window.Modernizr = function(e, t, n) {
        ...
        var d, p, h = "2.8.3",
            ...
            A = function(e, n, i, o) {
                ...
                if (parseInt(i, 10))
                    for (; i--;) a = t.createElement("div"), a.id = o ? o[i] : y + (i + 1), u.appendChild(a);
    ...
    function(e, t) {
        ...
        function p(e, t, n, i, o) {
            for (var r, s, a, l, u, p, h = t.createDocumentFragment(), f = [], g = 0, m = e.length; m > g; g++)
                if ((r = e[g]) || 0 === r)
            ...
            for (h.textContent = "", g = 0; r = f[g++];)
                ...
                else if (u = re.contains(r.ownerDocument, r), s = c(h.appendChild(r), "script"), u && d(s), n)
                for (p = 0; r = s[p++];) $e.test(r.type || "") && n.push(r);
            return h
        }
        ...
        function x(e, t, n, i) {
            ...
            if (h && (o = p(t, e[0].ownerDocument, !1, e, i), r = o.firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
                ...
                if (a)
                    for (u = s[s.length - 1].ownerDocument, re.map(s, b), d = 0; a > d; d++) l = s[d], $e.test(l.type || "") && !Se.access(l, "globalEval") && re.contains(u, l) && (l.src ? re._evalUrl && re._evalUrl(l.src) : re.globalEval(l.textContent.replace(qe, "")))
            }
            return e
        }
        ...
        function z(e, t, n) {
            ...
            for (M(c, u.opts.specialEasing); s > r; r++)
                if (i = z.prefilters[r].call(u, e, c, u.opts)) return re.isFunction(i.stop) && (re._queueHooks(u.elem, u.opts.queue).stop = re.proxy(i.stop, i)), i;
        ...
        var ce = function(e) {
            ...
            function y(e, t, n, o, r, s) {
                return o && !o[z] && (o = y(o)), r && !r[z] && (r = y(r, s)), i(function(i, s, a, l) {
                    var u, c, d, p = [],
                        ...
                        b = n ? r || (i ? e : f || o) ? [] : s : v;
                    if (n && n(v, b, a, l), o)
                        for (u = m(b, h), o(u, [], a, l), c = u.length; c--;)(d = u[c]) && (b[h[c]] = !(v[h[c]] = d));
                    if (i) {
                        if (r || e) {
                            if (r) {
            ...
            function v(e) {
                for (var t, n, i, o = e.length, r = x.relative[e[0].type], s = r || x.relative[" "], a = r ? 1 : 0, l = h(function(e) {
                    ...
                    if (n = x.relative[e[a].type]) c = [h(f(c), n)];
                    else {
                ...
                var o = n.length > 0,
                    ...
                    s = function(i, s, a, l, u) {
                        ...
                        for (u && (_ = s === E || s || u); f !== T && null != (c = b[f]); f++) {
                            if (r && c) {
                                for (d = 0, s || c.ownerDocument === E || (O(c), a = !$); p = e[d++];)
                                    if (p(c, s || E, a)) {
                                        l.push(c);
                                        break
                                    }
                        ...
                        return 1 === i && 0 === o ? function(e) {
                            ...
                            if (m) {
                                ...
                                if (f = [s ? m.firstChild : m.lastChild], s && v) {
                                    for (p = m, d = p[z] || (p[z] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), u = c[e] || [], h = u[0] === H && u[1], b = h && u[2], p = h && m.childNodes[h]; p = ++h && p && p[g] || (b = h = 0) || f.pop();)
                                        if (1 === p.nodeType && ++b && p === t) {
                                            c[e] = [H, h, b];
                                            break
                                        }
                                } else if (v && (p = t, d = p[z] || (p[z] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), u = c[e] || [], h = u[0] === H && u[1], b = h), !1 === b)
                                    for (;
            ...
            return d.prototype = x.filters = x.pseudos, x.setFilters = new d, C = t.tokenize = function(e, n) {
                ...
                if (n = n || [], 1 === d.length) {
                    ...
                    for (o = he.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !x.relative[a = s.type]);)
                        if ((l = x.find[a]) && (i = l(s.matches[0].replace(we, Te), ve.test(r[0].type) && c(t.parentNode) || t))) {
        ...
        re.fn.extend({
            ...
            closest: function(e, t) {
                for (var n, i = 0, o = this.length, r = [], s = he.test(e) || "string" != typeof e ? re(e, t || this.context) : 0; o > i; i++)
            ...
            remove: function(e, t, n, i, o) {
                ...
                if (m && (l = m.events)) {
                    for (t = (t || "").match(we) || [""], u = t.length; u--;)
                        if (a = ze.exec(t[u]) || [], h = g = a[1], f = (a[2] || "").split(".").sort(), h) {
        ...
        re.extend({
            ...
            clone: function(e, t, n) {
                ...
                if (!(ie.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || re.isXMLDoc(e)))
                    for (s = c(a), r = c(e), i = 0, o = r.length; o > i; i++) T(r[i], s[i]);
                if (t)
                    if (n)
            ...
            addClass: function(e) {
                ...
                if ("string" == typeof e && e)
                    for (t = e.match(we) || []; n = this[l++];)
                        if (o = F(n), i = 1 === n.nodeType && (" " + o + " ").replace(dt, " ")) {
        ...
        re.extend(re.event, {
            trigger: function(t, n, i, o) {
                ...
                if (s = a = i = i || X, 3 !== i.nodeType && 8 !== i.nodeType && !ft.test(h + re.event.triggered) && (h.indexOf(".") > -1 && (f = h.split("."), h = f.shift(), f.sort()), u = h.indexOf(":") < 0 && "on" + h, t = t[re.expando] ? t : new re.Event(h, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = f.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : re.makeArray(n, [t]), d = re.event.special[h] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                    ...
                    for (r = 0;
                        (s = p[r++]) && !t.isPropagationStopped();) t.type = r > 1 ? l : d.bindType || h, c = (Se.get(s, "events") || {})[t.type] && Se.get(s, "handle"), c && c.apply(s, n), (c = u && s[u]) && c.apply && Pe(s) && (t.result = c.apply(s, n), !1 === t.result && t.preventDefault());
    ...
    function() {
        ...
        for (w = {
                ...
                var e, t, n, i, o, r, s;
                for (t = arguments[0], i = 2 <= arguments.length ? X.call(arguments, 1) : [], r = 0, s = i.length; s > r; r++)
                    if (n = i[r])
                        for (e in n) G.call(n, e) && (o = n[e], null != t[e] && "object" == typeof t[e] && null != o && "object" == typeof o ? T(t[e], o) : t[e] = o);
                return t
            }, m = function(e) {
                var t, n, i, o, r;
        ...
        l = function(e) {
            ...
            var t, n, i, o;
            for (o = I.ajax.ignoreURLs, n = 0, i = o.length; i > n; n++)
            ...
            return u.running = !0, y.render(), e = _(), v = !1, g = E(function(t, n) {
                ...
                for (100 - y.progress, o = f = 0, r = !0, l = g = 0, b = D.length; b > g; l = ++g)
                    for (Q = D[l], h = null != A[l] ? A[l] : A[l] = [], a = null != (T = Q.elements) ? T : [Q], c = m = 0, w = a.length; w > m; c = ++m) s = a[c], d = null != h[c] ? h[c] : h[c] = new p(s), r &= d.done, d.done || (o++, f += d.tick(t));
    ...
    function(e, t) {
        ...
        e.prototype.tokenize = function(e) {
            ...
            if (r = this, e = r.prepareSearch(e, n), h = !e.query && n.sort_empty || n.sort, d = function(e, t) {
                ...
                for (i = 0, o = h.length; i < o; i++)(e.query || "$score" !== h[i].field) && a.push(h[i]);
            if (e.query) {
                for (p = !0, i = 0, o = a.length; i < o; i++)
                    if ("$score" === a[i].field) {
                        p = !1;
                        break
                    }
            ...
            return l = a.length, l ? 1 === l ? (s = a[0].field, u = c[0], function(e, n) {
                ...
                var i, o, r;
                for (i = 0; i < l; i++)
                    if (r = a[i].field, o = c[i] * t(d(r, e), d(r, n))) return o;
                return 0
            } : null
            ...
            a = function() {
                ...
                for (n in s)
                    if (s.hasOwnProperty(n))
                        for (i = s[n].substring(2, s[n].length - 1), o += i, e = 0, t = i.length; e < t; e++) r[i.charAt(e)] = n;
    ...
    function(e, t) {
        ...
        return o.mixin(D), n.mixin(D), e.extend(D.prototype, {
            ...
            setActiveOption: function(t, n, i) {
                ...
                u.$activeOption && u.$activeOption.removeClass("active"), u.$activeOption = null, t = e(t), t.length && (u.$activeOption = t.addClass("active"), !n && S(n) || (o = u.$dropdown_content.height(), r = u.$activeOption.outerHeight(!0), n = u.$dropdown_content.scrollTop() || 0, s = u.$activeOption.offset().top - u.$dropdown_content.offset().top + n, a = s, l = s - o + r, s + r > o + n ? u.$dropdown_content.stop().animate({
                    scrollTop: l
            ...
            search: function(t) {
                ...
                if (t !== r.lastQuery ? (r.lastQuery = t, i = r.sifter.search(t, e.extend(a, {
                    ...
                    for (n = i.items.length - 1; n >= 0; n--) - 1 !== r.items.indexOf(C(i.items[n].id)) && i.items.splice(n, 1);
                return i
            },
            refreshOptions: function(t) {
                ...
                for (s = T.items.length, "number" == typeof b.settings.maxOptions && (s = Math.min(s, b.settings.maxOptions)), a = {}, l = [], n = 0; n < s; n++)
                    for (u = b.options[T.items[n].id], c = b.render("option", u), d = u[b.settings.optgroupField] || "", p = e.isArray(d) ? d : [d], o = 0, r = p && p.length; o < r; o++) d = p[o], b.optgroups.hasOwnProperty(d) || (d = ""), a.hasOwnProperty(d) || (a[d] = [], l.push(d)), a[d].push(c);
                for (this.settings.lockOptgroupOrder && l.sort(function(e, t) {
                        return (b.optgroups[e].$order || 0) - (b.optgroups[t].$order || 0)
                    }), h = [], n = 0, s = l.length; n < s; n++) d = l[n], b.optgroups.hasOwnProperty(d) && a[d].length ? (f = b.render("optgroup_header", b.optgroups[d]) || "", f += a[d].join(""), h.push(b.render("optgroup", e.extend({}, b.optgroups[d], {
                    html: f
                })))) : h.push(a[d].join(""));
                if (x.html(h.join("")), b.settings.highlight && T.query.length && T.tokens.length)
                    for (n = 0, s = T.tokens.length; n < s; n++) i(x, T.tokens[n].regex);
                if (!b.settings.hideSelected)
                    for (n = 0, s = b.items.length; n < s; n++) b.getOption(b.items[n]).addClass("selected");
                g = b.canCreate(w), g && (x.prepend(b.render("option_create", {
                    input: w
                })), v = e(x[0].childNodes[0])), b.hasOptions = T.items.length > 0 || g, b.hasOptions ? (T.items.length > 0 ? (y = P && b.getOption(P), y && y.length ? m = y : "single" === b.settings.mode && b.items.length && (m = b.getOption(b.items[0])), m && m.length || (m = v && !b.settings.addPrecedence ? b.getAdjacentOption(v, 1) : x.find("[data-selectable]:first"))) : m = v, b.setActiveOption(m), t && !b.isOpen && b.open()) : (b.setActiveOption(null), t && b.isOpen && b.close())
            },
            ...
            removeItem: function(e, t) {
                var n, i, o, r = this;
                n = "object" == typeof e ? e : r.getItem(e), e = C(n.attr("data-value")), -1 !== (i = r.items.indexOf(e)) && (n.remove(), n.hasClass("active") && (o = r.$activeItems.indexOf(n[0]), r.$activeItems.splice(o, 1)), r.items.splice(i, 1), r.lastQuery = null, !r.settings.persist && r.userOptions.hasOwnProperty(e) && r.removeOption(e, t), i < r.caretPos && r.setCaret(r.caretPos - 1), r.refreshState(), r.updatePlaceholder(), r.updateOriginalInput({
                    silent: t
        ...
        }, e.fn.selectize.defaults = D.defaults, e.fn.selectize.support = {
            validity: P
...
! function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        changeMovie: function(e) {
            var t = this,
                n = t.get(0);
            n.opt.startAt = 0, n.opt.stopAt = 0, n.opt.mask = !1, n.opt.mute = !0, n.hasData = !1, n.hasChanged = !0, n.player.loopTime = void 0, e && jQuery.extend(n.opt, e), n.videoID = getYTPVideoID(n.opt.videoURL).videoID, "true" == n.opt.loop && (n.opt.loop = 9999), jQuery(n.playerEl).CSSAnimate({
                opacity: 0
            }, 200, function() {
        ...
        removeFilter: function(e, t) {
            return this.each(function() {
                ...
                if ("function" == typeof e && (t = e, e = null), e) jQuery(this).YTPApplyFilter(e, 0), "function" == typeof t && t(e);
                    ...
                    for (var i in n.filters) jQuery(this).YTPApplyFilter(i, 0), "function" == typeof t && t(i)
            })
        },
        getFilters: function() {
            ...
            e.player.playVideo(), e.player.seekTo(i, !0), e.checkForStartAt = setInterval(function() {
                ...
                if (e.player.getDuration() > 0 && e.player.getCurrentTime() >= i && n) {
                    ...
                    if (o.time = e.currentTime, jQuery(e).trigger(o), e.preventTrigger = !0, e.state = 2, jQuery(e).YTPPause(), e.opt.mute || jQuery(e).YTPUnmute(), e.canTrigger = !0, e.opt.autoPlay) {
                        ...
                        r.time = e.currentTime, jQuery(e).trigger(r), t.css("background-image", "none"), jQuery(e.playerEl).CSSAnimate({
                            opacity: 1
    ...
    animate: function(e, t, n, i, o) {
        return this.each(function() {
            ...
            if (s.CSSqueue = null, s.eventType = l.type, 0 !== a.length && e) {
                if (e = jQuery.normalizeCss(e), s.CSSAIsRunning = !0, "function" == typeof t && (o = t, t = jQuery.fx.speeds._default), "function" == typeof n && (i = n, n = 0), "string" == typeof n && (o = n, n = 0), "function" == typeof i && (o = i, i = "cubic-bezier(0.65,0.03,0.36,0.72)"), "string" == typeof t)
        ...
        e.simpleSlider = {
            ...
            init: function(n) {
                return this.each(function() {
                    ...
                    o.prepend(s), i.level = s, o.css({
                        cursor: "default"
                    }), "auto" == i.opt.scale && (i.opt.scale = e(i).outerWidth()), o.updateSliderVal(), i.opt.readonly || (o.on(e.simpleSlider.events.start, function(e) {
                        t && (e = e.changedTouches[0]), i.canSlide = !0, o.updateSliderVal(e), o.css({
                            cursor: "col-resize"
                        }), e.preventDefault(), e.stopPropagation()
                    }), e(document).on(e.simpleSlider.events.move, function(n) {
                        t && (n = n.changedTouches[0]), i.canSlide && (e(document).css({
                            cursor: "default"
    ...
    function(e, t) {
        ...
        function d(e, t) {
            ...
            for (n = 2; n < i.length; n++)
                if (t in i[n] && i[n].hasOwnProperty(t)) return void(e[t] = i[n][t])
        }
        ...
        function p(t, n) {
            var i, o, r = ["data", "tag", "id", "events", "onces"],
                s = {};
            if (t.td)
                for (i in t.td) t.td.hasOwnProperty(i) && "options" !== i && "values" !== i && (s[i] = t.td[i]);
        ...
        function k() {
            ...
            s.add = function(e, t, n, r) {
                ...
                for (a = i[e].length; a;)
                    if (a--, (l = i[e][n ? a : i[e].length - a - 1]) && o[l]) {
                ...
                if (t)
                    if (n)
                        for (r = i[e].length - 1; r >= 0 && (a = i[e][r], !t(o[a].tag)); r--);
                    else
                        for (r = 0; r < i[e].length && (a = i[e][r], !t(o[a].tag)); r++);
                ...
                if (i.clusterer)
                    for (n in i.clusterer)
                        if (!1 !== (t = o[i.clusterer[n]].obj.getById(e))) return t;
                return !1
            }, s.objClearById = function(e) {
                var t;
                if (i.clusterer)
                    for (t in i.clusterer)
                        if (o[i.clusterer[t]].obj.clearById(e)) return !0;
                return null
                ...
                var a;
                if (i.clusterer && (e.inArray("marker", t) >= 0 || !t.length))
        ...
        function j(t, n, o) {
            ...
            function s() {
                var e;
                for (e in o)
                    if (o.hasOwnProperty(e) && !l.hasOwnProperty(e)) return e
            }
            var a, l = {},
                u = this,
                c = {
        ...
        function A(t, i, o) {
            ...
            s(), j.getById = function(e) {
                ...
                n = n || {}, n.id = a(n.id), j.clearById(n.id), n.options || (n.options = {}), n.options.position = e.getPosition(), u(t, {
                    td: n
                }, e, n.id), Y[n.id] = A.length, O[A.length] = n.id, A.push(e), $.push(n), L.push(n.data || {}), P = !0
            }, j.td = function(e) {
                return $[e]
            }, j.value = function(e) {
                return L[e]
        ...
        function Q(o) {
            ...
            function b(n) {
                ...
                return c.sort(function(e, t) {
                    ...
                    if (n.force || v > 1)
                        for (d = 0; d < c.length; d++) c[d] <= v && (p = l[c[d]]);
            ...
            function w(t, n, i) {
                ...
                return s || (t.td.values = [{
                    ...
                    var a, l, c, d, h = p(t, s);
                    if (h.options[i])
                        if (h.options[i][0][0] && H(h.options[i][0][0]))
                            for (l = 0; l < h.options[i].length; l++)
                                for (c = 0; c < h.options[i][l].length; c++) h.options[i][l][c] = y(h.options[i][l][c]);
                        else
                            for (l = 0; l < h.options[i].length; l++) h.options[i][l] = y(h.options[i][l]);
                    h.options.map = E, d = new M[n](h.options), r.push(d), a = S.add({
                        td: h
                    }, n.toLowerCase(), d), u(o, {
                        td: h
                    }, d, a)
            ...
            x._plan = function(e) {
                ...
                return r || (t.td.values = [{
                    ...
                    d.append(c.options.content), l = new L(E, c.options, y(c) || y(s), d), i.push(l), d = null, n || (a = S.add(t, "overlay", l), u(o, {
                        td: c
                    }, l, a))
                ...
                return s || (t.opts.position = t.latLng || y(t.opts.position), t.td.values = [{
                    ...
                    var r, s, a = p(t, i);
                    a.options.position = y(a.options.position ? a.options.position : i), a.options.position && (a.options.map = E, l && (E.setCenter(a.options.position), l = !1), s = new D.classes.Marker(a.options), n.push(s), r = S.add({
                        td: a
                    }, "marker", s), u(o, {
                        td: a
                    }, s, r))
                ...
                s || (n.latLng && (n.opts.position = n.latLng), n.td.values = [{
                    ...
                    var l, c, d = p(n, a);
                    d.options.position = y(d.options.position ? d.options.position : a.latLng), E || m(d.options.position), c = new D.classes.InfoWindow(d.options), c && (r(d.open) || d.open) && (s ? c.open(E, d.anchor || t) : c.open(E, d.anchor || (n.latLng ? t : n.session.marker ? n.session.marker : t))), i.push(c), l = S.add({
                        td: d
                    }, "infowindow", c), u(o, {
                        td: d
                    }, c, l)
                ...
                return i || (t.opts.center = t.latLng || y(t.opts.center), t.td.values = [{
                    ...
                    var r, s, a = p(t, i);
                    a.options.center = y(a.options.center ? a.options.center : i), E || m(a.options.center), a.options.map = E, s = new D.classes.Circle(a.options), n.push(s), r = S.add({
                        td: a
                    }, "circle", s), u(o, {
                        td: a
                    }, s, r)
                ...
                if (e.latLng) n.push(e.latLng);
                    ...
                    for (n = g(e.td.locations || []), t = 0; t < n.length; t++) n[t] = y(n[t]);
                if (n.length) O().getElevationForLocations({
                    locations: n
                }, i);
                else {
                    if (e.td.path && e.td.path.length)
                        for (t = 0; t < e.td.path.length; t++) n.push(y(e.td.path[t]));
                ...
                return i || (t.td.values = [{
                    ...
                    var r, s, a = p(t, i);
                    a.options.bounds = v(a.options.bounds ? a.options.bounds : i), E || m(a.options.bounds.getCenter()), a.options.map = E, s = new D.classes.Rectangle(a.options), n.push(s), r = S.add({
                        td: a
                    }, "rectangle", s), u(o, {
                        td: a
                    }, s, r)
                ...
                return i || (t.td.values = [{
                    ...
                    var r, s, a, c = p(t, i);
                    E || m(), a = c.options, c.options.opts && (a = c.options.opts, c.options.url && (a.url = c.options.url)), a.map = E, s = l("3.10") ? new D.classes.KmlLayer(a) : new D.classes.KmlLayer(a.url, a), n.push(s), r = S.add({
                        td: c
                    }, "kmllayer", s), u(o, {
                        td: c
                    }, s, r)
    ...
    function(e, t) {
        ...
        function n(e) {
            ...
            for (var t = 1; t < arguments.length; t++) {
                var n = arguments[t];
                if (n)
                    for (var i in n) n.hasOwnProperty(i) && ("object" == typeof n[i] ? deepExtend(e[i], n[i]) : e[i] = n[i])
            }
            return e
        }
